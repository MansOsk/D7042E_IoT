...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		final ServiceRegistryRequestDTO energyService1 = createServiceRegistryRequest(EConstants.ELECTRICITY_GENERATION_SERVICE, EConstants.ELECTRICITY_GENERATION_SERVICE_URI, HttpMethod.GET);
		...
		final ServiceRegistryRequestDTO energyService2 = createServiceRegistryRequest(EConstants.ELECTRICITY_GENERATION_SERVICE_START, EConstants.ELECTRICITY_GENERATION_SERVICE_START_URI, HttpMethod.POST);
		...
		final ServiceRegistryRequestDTO energyService3 = createServiceRegistryRequest(EConstants.ELECTRICITY_GENERATION_SERVICE_STOP, EConstants.ELECTRICITY_GENERATION_SERVICE_STOP_URI, HttpMethod.POST);
	...
	public void customDestroy() {
		arrowheadService.unregisterServiceFromServiceRegistry(EConstants.ELECTRICITY_GENERATION_SERVICE, EConstants.ELECTRICITY_GENERATION_SERVICE_URI);
		logger.info("Service unregistered: {}", EConstants.ELECTRICITY_GENERATION_SERVICE);
		arrowheadService.unregisterServiceFromServiceRegistry(EConstants.ELECTRICITY_GENERATION_SERVICE_START, EConstants.ELECTRICITY_GENERATION_SERVICE_START_URI);
		logger.info("Service unregistered: {}", EConstants.ELECTRICITY_GENERATION_SERVICE_START);
		arrowheadService.unregisterServiceFromServiceRegistry(EConstants.ELECTRICITY_GENERATION_SERVICE_STOP, EConstants.ELECTRICITY_GENERATION_SERVICE_STOP_URI);
